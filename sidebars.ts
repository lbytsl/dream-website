      ...
      items: [
        {
          ...
          items: ["skills/prompt-ops/getting-started", "skills/prompt-ops/workflow"],
        },
        {
          type: "category",
          label: "Knowledge Base",
          link: { type: "doc", id: "skills/knowledge-base/index" },
          items: ["skills/knowledge-base/rag", "skills/knowledge-base/vector-store"],
        },
        {
          type: "category",
          label: "RAG",
          link: { type: "doc", id: "skills/rag/index" },
          items: ["skills/rag/basic", "skills/rag/advanced"],
        },
        {
          type: "category",
          label: "Dify",
          link: { type: "doc", id: "skills/dify/index" },
          items: ["skills/dify/chatflow", "skills/dify/plugins"],
        },
        {
          type: "category",
          label: "Coding",
          link: { type: "doc", id: "skills/coding/index" },
          items: ["skills/coding/code-review", "skills/coding/test-gen"],
        },
        {
          type: "category",
          label: "PPT",
          link: { type: "doc", id: "skills/ppt/index" },
          items: ["skills/ppt/design", "skills/ppt/automation"],
        },
      ],
    },
  ],
