...
const openSourceProjects = [
  { name: "PromptOps", description: "Prompt engineering toolkit with version control" },
  { name: "RAG-Toolkit", description: "Production-ready RAG pipeline components" },
  { name: "AI-Dev-Templates", description: "AI project starter templates" },
];
...
export default function About(): React.ReactNode {
  ...
  return (
    <Layout
      title="关于我"
      description="关于 AI Developer Hub 的作者 - AI 开发者与技术写作者"
    >
        ...
        <div className={styles.container}>
          ...
          <section className={styles.profile}>
            ...
            <h1 className={styles.name}>
              <Translate id="about.name">AI Developer</Translate>
            </h1>
            <p className={styles.title}>
              <Translate id="about.tagline">AI Developer & Tech Writer</Translate>
            </p>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.contactLinks}>
              <a href="https://github.com/your-github-username" target="_blank" rel="noopener noreferrer" className="button button--primary button--lg">
